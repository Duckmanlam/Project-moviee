  ...
  rating: [
    {
      ...
      posterImage:
        "https://lh3.google.com/u/0/d/1h763ap7qUPuZw7AaFGDjqAMkVmfE9-Fk=w1920-h963-iv1",
      mpaRatings: "PG-13",
      value: 5,
      genre: [
        {
      ...
      {data.rating.map((movie, index) => (
        <div key={index} className="mt-8">
          <div className="flex ">
            ...
            >
              <img className="" src={movie.posterImage} alt={movie.title} />
              <div className="ml-4 flex flex-col space-y-3 justify-center">
                ...
                <div className="flex">
                  ...
                  <p className="text-12-500 text-Grayscale70 ml-1 ">
                    {movie.genre[0].name} • {movie.genre[1].name}
                  </p>
                </div>
                <div className="flex">
                  <svg
                  ...
                  >
                    <path
                      d="M10.4416 1.42495L11.9083 4.35828C12.1083 4.76662 12.6416 5.15828 13.0916 5.23328L15.7499 5.67495C17.4499 5.95828 17.8499 7.19162 16.6249 8.40828L14.5583 10.4749C14.2083 10.8249 14.0166 11.4999 14.1249 11.9833L14.7166 14.5416C15.1833 16.5666 14.1083 17.3499 12.3166 16.2916L9.82492 14.8166C9.37492 14.5499 8.63326 14.5499 8.17492 14.8166L5.68326 16.2916C3.89992 17.3499 2.81659 16.5583 3.28326 14.5416L3.87492 11.9833C3.98326 11.4999 3.79159 10.8249 3.44159 10.4749L1.37492 8.40828C0.158257 7.19162 0.549924 5.95828 2.24992 5.67495L4.90826 5.23328C5.34992 5.15828 5.88326 4.76662 6.08326 4.35828L7.54992 1.42495C8.34992 -0.166715 9.64992 -0.166715 10.4416 1.42495Z"
                      fill="#FFCD1A"
                    />
                  </svg>

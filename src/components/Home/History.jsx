            ...
            <div className="group card transition-transform duration-300 overflow-hidden rounded-xl aspect-w-2 aspect-h-3 w-full h-80">
              ...
              >
                ...
                <div className="hidden group-hover:flex absolute bottom-0 py-3 left-0 right-0 w-full h-1/2  flex-col justify-end px-3 z-[6]">
                  <div className="text-white block font-light text-lg group-hover:text-white transition-colors duration-300">
                    {movie?.title}
                  </div>
                  <div className="flex items-end  text-light-gray text-xs">
                    <span className="inline-block text-sm text-white/70 border border-light-gray px-1 py-[2px] rounded ml-auto line-clamp-1 truncate max-w-[8rem]">
                      {" "}
                      {movie.genre.map((genre) => genre.name).join(", ")}
                    </span>
                  </div>
                </div>
                <div className="absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 bg-white rounded-full text-Primary text-[36px] flex z-[6] scale-50 opacity-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300">
